...
export type PageType = 'homepage' | 'content' | 'game_detail' | 'video_detail' | 'reference_detail' | 'reference_listing' | 'required' | 'listing' | 'utility' | 'tool_detail' | 'unknown';
...
export interface CheckOptions {
  ...
  resumeFile?: string;         // checkpoint file for resuming interrupted AI analysis
